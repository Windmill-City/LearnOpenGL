...
std::u16string CodeCvt::to_u16string(const std::string_view u8) noexcept
{
    ...
    for (char ch8 : u8)
    {
        ...
        char cp_7_m  = 0b10000000;
        char cp_11_m = 0b11100000;
        char cp_16_m = 0b11110000;
        char cp_21_m = 0b11111000;
        char cp_26_m = 0b11111100;
        char cp_31_m = 0b11111110;

        // UTF-8 CodePoints Matcher
        char cp_7  = 0b00000000;
        char cp_11 = 0b11000000;
        char cp_16 = 0b11100000;
        char cp_21 = 0b11110000;
        char cp_26 = 0b11111000;
        char cp_31 = 0b11111100;

        // Codepoint Value Mask
        char cp_v_m = 0b11000000;
        // Codepoint Value Matcher
        char cp_v   = 0b10000000;
